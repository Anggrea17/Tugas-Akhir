...
<body class="bg-gray-100 min-h-screen" x-cloak 
      x-data="{ showAddModal: false, sidebarOpen: false, modalHapus: false, hapusUrl: '', artikelToDelete: null }">
    ...
    <div class="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden relative shadow-2xl">
        ...
        <div class="overflow-y-auto max-h-[90vh]">
            ...
            <div class="relative p-8 border-b">
                <h2 class="text-3xl font-bold text-gray-800 mb-3" x-text="selectedArtikel?.judul"></h2>
                
                <!-- Meta Info -->
                <div class="flex flex-wrap items-center gap-3 text-sm">
                    <span class="px-3 py-1.5 bg-gradient-to-r from-yellow-400 to-orange-400 text-white rounded-full font-semibold shadow-sm"
                    ...
                    <div class="flex items-center gap-2 text-gray-500">
                        ...
                        <span x-text="new Date(selectedArtikel?.tanggal_post).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })"></span>
                    </div>
...
<div x-show="showAddModal" x-transition:enter="transition ease-out duration-200"
    ...
    <div class="bg-white p-6 rounded-2xl w-full max-w-3xl max-h-[85vh] overflow-y-auto relative shadow-xl">
        ...
        <form method="POST" action="{{ route('admin.kelolaartikel.store') }}"
            ...
            <div class="mb-4">
                <label for="kategori"
                    class="block text-sm font-medium text-gray-700 mb-1">Kategori Artikel</label>
            ...
            <!-- Sumber Artikel -->
            <div class="mb-4">
                <label class="block text-sm font-medium text-gray-700 mb-1">Sumber Artikel</label>
                    ...
                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                ...
                                <span class="font-medium text-gray-700" x-text="artikelToDelete?.judul"></span>?
                            </p>
                        </div>
                    </div>
                </div>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('artikelData', () => ({
        ...
        openHapusModal(url, judulArtikel) {
            this.hapusUrl = url;
            this.artikelToDelete = { judul: judulArtikel };
