...
<div x-cloak x-show="modalDetail"
            ...
            <div class="p-8 space-y-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-purple-50 p-4 rounded-xl text-center border border-purple-200">
                        ...
                        <p class="text-lg font-bold text-purple-900" x-text="formatDate(detailData.tanggal_catat)"></p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div class="bg-white p-5 rounded-xl border-2 border-blue-300">
                            ...
                            <p class="text-3xl font-bold text-blue-600"
                                x-text="(detailData.berat !== null && detailData.berat !== '' && detailData.berat > 0) ? detailData.berat : '-'"></p>
                        ...
                        <div class="bg-white p-5 rounded-xl border-2 border-green-300">
                            ...
                            <p class="text-3xl font-bold text-green-600"
                                x-text="(detailData.tinggi !== null && detailData.tinggi !== '' && detailData.tinggi > 0) ? detailData.tinggi : '-'"></p>
